...
import { Target, Users, TrendingUp, BarChart3, Search } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
      <Card 
        ...
        onClick={() => onStatClick("discovery")}
      >
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Discovery Engine</CardTitle>
          <Search className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold text-blue-600">Enhanced</div>
          <p className="text-xs text-muted-foreground">ML-powered discovery</p>
        </CardContent>
      </Card>
